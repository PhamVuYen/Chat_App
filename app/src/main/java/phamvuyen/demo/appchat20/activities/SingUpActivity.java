...
import phamvuyen.demo.appchat20.R;
import phamvuyen.demo.appchat20.databinding.ActivitySingUpBinding;
...
public class SingUpActivity extends AppCompatActivity {
    ...
    private void singUp(){
        ...
        user.put(Constants.KEY_IMAGE, binding.textAddImage.toString());
    ...
    private String encodeImage(Bitmap bitmap){
        ...
        previewBitmap.compress(Bitmap.CompressFormat.JPEG, 50, byteArrayOnputStream);
        byte[] bytes = byteArrayOnputStream.toByteArray();
